...
LOG_DIR="/jpfs/qingyu/data-harness/output/stage1_logs"
...
for ((i=0; i<$NUM_PODS; i++)); do
    ...
    (
        ...
        kubectl exec -n $NAMESPACE $POD -- bash -c "python /jpfs/qingyu/data-harness/recipe/thinking_to_cot/stage1_run_shard.py \
